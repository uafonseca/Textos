...
(
    ...
    INDEX     IDX_A393D2FBCD33232C (contry_id),
    PRIMARY KEY (id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
ALTER TABLE state
    ADD CONSTRAINT FK_A393D2FBCD33232C FOREIGN KEY (contry_id) REFERENCES country (id);
...
INSERT INTO `state` (`id`, `contry_id`, `name`)
VALUES (1, 3, 'Azerbaijan'),
